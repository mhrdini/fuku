  ...
  return (
    <Button
      ...
      className={cn(
        ...
        isHoveredStart &&
          !modifiers.selected &&
          'rounded-l-none rounded-r-none bg-accent text-accent-foreground dark:bg-accent/50 dark:text-accent-foreground',
        isHoveredEnd &&
          !modifiers.selected &&
          'rounded-r-none rounded-l-none bg-accent text-accent-foreground dark:bg-accent/50 dark:text-accent-foreground',
        isHoveredStart &&
          isHoveredEnd &&
          !modifiers.selected &&
          'rounded-none bg-accent text-accent-foreground dark:bg-accent/50 dark:text-accent-foreground',
