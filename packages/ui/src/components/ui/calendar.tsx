  ...
  return (
    <Button
      ...
      className={cn(
        ...
        isInHovered
        && !modifiers.selected
        && 'bg-accent text-accent-foreground dark:bg-accent/50 dark:text-accent-foreground rounded-none',
        isHoveredStart
        && !modifiers.selected
        && 'bg-accent text-accent-foreground dark:bg-accent/50 dark:text-accent-foreground rounded-l-none rounded-r-none',
        isHoveredEnd
        && !modifiers.selected
        && 'bg-accent text-accent-foreground dark:bg-accent/50 dark:text-accent-foreground rounded-l-none rounded-r-none',
        isHoveredStart
