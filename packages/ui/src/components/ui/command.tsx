...
import {
  ...
  DialogHeader,
  DialogTitle,
} from '@fuku/ui/components/ui/dialog'
import { InputGroup, InputGroupAddon } from '@fuku/ui/components/ui/input-group'
...
function CommandInput({
  ...
  return (
    <div
      ...
      className={cn('border-b pb-0', className)}
    >
...
function CommandEmpty({
  ...
  return (
    <CommandPrimitive.Empty
      ...
      className={cn('p-4 text-center text-muted-foreground text-xs', className)}
      {...props}
    />
  )
}
...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      {/* <CheckIcon className='shrink ml-auto hidden group-data-[checked=true]/command-item:flex' /> */}
    </CommandPrimitive.Item>
  )
}
